...
class TAB5ShardPlugin:
  def input(self, inputfile):
    self.file_tab5 = inputfile
  def run(self):
      pass
  def output(self, output_dir):
    ...
    for a_limit in limits:
        ...
        output_file = output_dir + "/" + "myoutput" + "-" + str(a_limit) + "-tab5.txt"

        with open(self.file_tab5, 'r') as input_file:
